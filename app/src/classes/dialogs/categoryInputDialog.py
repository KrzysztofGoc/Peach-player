...
# Form implementation generated from reading ui file '.\songInputDialog.ui'
#
...
class categoryInputDialog(QtWidgets.QDialog):
    ...
    def setupUi(self, categoryInputDialog):
        ...
        categoryInputDialog.resize(524, 225)
        ...
        categoryInputDialog.setMinimumSize(QtCore.QSize(524, 225))
        categoryInputDialog.setMaximumSize(QtCore.QSize(524, 225))
        categoryInputDialog.setStyleSheet("#Dialog{\n"
                                          "    border-radius: 8px;\n"
                                          ...
                                          "}\n"
                                          "")
        categoryInputDialog.setSizeGripEnabled(False)
        categoryInputDialog.setModal(True)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 524, 225))
        ...
        self.categoryInputDialogExitButton.setText("Exit")
        ...
        self.categoryInputDialogCategoryNameQLineEdit = QtWidgets.QLineEdit(self.frame_8)
        self.categoryInputDialogCategoryNameQLineEdit.setInputMask("")
        self.categoryInputDialogCategoryNameQLineEdit.setObjectName("categoryInputDialogCategoryNameQLineEdit")
        self.verticalLayout_6.addWidget(self.categoryInputDialogCategoryNameQLineEdit)
        ...
        self.categoryInputDialogSynchronizeQRadioButton = QtWidgets.QRadioButton(self.frame_7)
        self.categoryInputDialogSynchronizeQRadioButton.setText("Synchronize")
        self.categoryInputDialogSynchronizeQRadioButton.setObjectName("categoryInputDialogSynchronizeQRadioButton")
        self.horizontalLayout_2.addWidget(self.categoryInputDialogSynchronizeQRadioButton)
        ...
        self.categoryInputDialogAddButton.setStyleSheet("background-color: rgb(255, 255, 0);")
        ...
        self.retranslateUi(categoryInputDialog)
        QtCore.QMetaObject.connectSlotsByName(categoryInputDialog)

    def retranslateUi(self, categoryInputDialog):
        _translate = QtCore.QCoreApplication.translate
        categoryInputDialog.setWindowTitle(_translate("categoryInputDialog", "Dialog"))
        self.categoryInputDialogCategoryNameQLineEdit.setText(_translate("categoryInputDialog", "Category name"))
