...
class SongAdder(QtWidgets.QFrame):
    ...
    def setup_layout(self):
        ...
        sizePolicy.setHeightForWidth(self.frame_407.sizePolicy().hasHeightForWidth())
        self.frame_407.setSizePolicy(sizePolicy)
        self.frame_407.setMinimumSize(QtCore.QSize(0, 56))
        self.frame_407.setMaximumSize(QtCore.QSize(16777215, 56))
        self.frame_407.setStyleSheet("")
        self.frame_407.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame_407.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame_407.setObjectName("mainPageAllSongsSongAdderQFrame")
        self.horizontalLayout_107 = QtWidgets.QHBoxLayout(self.frame_407)
        ...
        self.frame_408 = QtWidgets.QFrame(self.frame_407)
        ...
        self.mainPageAllSongsFavouriteQPushButton.setIcon(icon8)
        ...
        self.frame_88 = QtWidgets.QFrame(self.frame_407)
        ...
        self.verticalLayout_275 = QtWidgets.QVBoxLayout(self.frame_88)
        ...
        sizePolicy.setHeightForWidth(
            self.mainPageAllSongsSelectSongQPushButton.sizePolicy().hasHeightForWidth())
        self.mainPageAllSongsSelectSongQPushButton.setSizePolicy(sizePolicy)
        self.mainPageAllSongsSelectSongQPushButton.setMinimumSize(QtCore.QSize(125, 0))
        self.mainPageAllSongsSelectSongQPushButton.setText("Choose song file")
        self.verticalLayout_275.addWidget(self.mainPageAllSongsSelectSongQPushButton)
        self.horizontalLayout_107.addWidget(self.frame_88)
        self.frame_411 = QtWidgets.QFrame(self.frame_407)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainPageAllSongsSelectSongMiniatureQPushButton.setMinimumSize(QtCore.QSize(125, 0))
        self.mainPageAllSongsSelectSongMiniatureQPushButton.setText("Choose miniature placeholder")
        ...
        self.frame_454 = QtWidgets.QFrame(self.frame_407)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainPageAllSongsSongTitleQLineEdit.setText("Song title")
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainPageAllSongsSongTitleQLineEdit.setMinimumSize(QtCore.QSize(125, 0))
        ...
        self.frame_412 = QtWidgets.QFrame(self.frame_407)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainPageAllSongsSongAuthorQComboBox = QtWidgets.QComboBox(self.frame_412)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.frame_453 = QtWidgets.QFrame(self.frame_407)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainPageAllSongsSongCategoryQComboBox = QtWidgets.QComboBox(self.frame_453)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainPageAllSongsSongCategoryQComboBox.setMinimumSize(QtCore.QSize(125, 0))
        ...
        self.frame_455 = QtWidgets.QFrame(self.frame_407)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainPageAllSongsSongAlbumQComboBox = QtWidgets.QComboBox(self.frame_455)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.mainPageAllSongsSongAlbumQComboBox.setMinimumSize(QtCore.QSize(125, 0))
